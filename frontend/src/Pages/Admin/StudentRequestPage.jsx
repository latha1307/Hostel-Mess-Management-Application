  ...
  return (
    <>
      <div className="flex lg:h-[100vh]">
        ...
        {/* Content Area */}
        <div className={`flex flex-col justify-center p-10 pt-2 pb-2 w-full transition-all duration-300 ease-in-out`}>
          <div>
            {/* Styled H1 Tag */}
            <h1 className="text-3xl font-bold text-center text-[#000000] mb-4 -mt-20">
              Student Requests to Join Hostel
            </h1>
          </div>
          <StudentRequests />
        </div>
