...
export const RegisterForm = () => {
            ...
            <div className=" space-y-6 border-b p-10">
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-1 gap-2 ">
                    ...
                    <div className="space-y-2">
                        ...
                        <input name="roll_no" onChange={handleInput} className="w-10/12 px-2 py-2 rounded-lg font-medium font-sans border border-gray-500  text-sm  focus:border-3   bg-white  focus:border-gray-400" type="number" />
                    ...
                    <div className="space-y-2 font-sans">
                        ...
                        <select name="course" type="text" onChange={handleInput} id="courses" className="bg-white border px-2 py-2 font-medium cursor-pointer font-sans border-gray-500 text-gray-900 text-sm rounded-lg focus:border-gray-400 w-10/12">
                            <option defaultValue={"Select Course"} className="font-sans">Select Course</option>
                    ...
                    <div className="space-y-2">
  <label htmlFor="fyear" className="font-sans">
  ...
  <select
    ...
    id="fyear"
    className="bg-white border px-2 py-2 font-medium cursor-pointer font-sans border-gray-500 text-gray-900 text-sm rounded-lg focus:border-gray-400 w-10/12"
    defaultValue={"Year"}
  >
    <option value="" disabled>
      Year
    </option>
    <option value="1" className="font-sans">
      First Year
    </option>
            ...
            <div className=" space-y-4 border-b p-10">
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-1 gap-2">
                    ...
                    <div className="space-y-2 font-sans">
                        ...
                        <select type="text" id="blood-group" onChange={handleInput} name="blood_group" className="bg-white border px-2 py-2 font-medium cursor-pointer font-sans border-gray-500 text-gray-900 text-sm rounded-lg focus:border-gray-400 w-10/12">
                            <option  defaultValue={"Select Group"} className="font-sans">Select Group</option>
                    ...
                    <div className="space-y-2">
                        ...
                        <select id="gender" onChange={handleInput} name="gender" className="bg-white border px-2 py-2 font-medium cursor-pointer font-sans border-gray-500 text-gray-900 text-sm rounded-lg focus:border-gray-400 w-10/12 ">
                            <option defaultValue={"Select Group"} className="font-sans">Select Gender</option>
                    ...
                    <div className="space-y-2">
                        ...
                        <select id="nation" onChange={handleInput} name="nationality" className="bg-white border px-2 py-2 font-medium cursor-pointer font-sans border-gray-500 text-gray-900 text-sm rounded-lg focus:border-gray-400 w-10/12 ">
                            <option defaultValue={"Select Group"} className="font-sans">Select Nationality</option>
                    ...
                    <div className="space-y-2 font-sans">
                        ...
                        <select name="community" onChange={handleInput} id="community" className="bg-white border px-2 py-2 font-medium cursor-pointer font-sans border-gray-500 text-gray-900 text-sm rounded-lg focus:border-gray-400 w-10/12">
                            <option defaultValue={"Select Group"} className="font-sans">Select Community</option>
                    ...
                    <div className="space-y-2">
                        ...
                        <select name="differently_abled" onChange={handleInput} id="differently-abled" className="bg-white border px-2 py-2 font-medium cursor-pointer font-sans border-gray-500 text-gray-900 text-sm rounded-lg focus:border-gray-400 w-10/12 ">
                            <option defaultValue={"Select Group"} className="font-sans">-------</option>
            ...
            <div className=" space-y-4 border-b p-10">
                <h6 className="text-2xl text-secondary font-bold tracking-wider ">Parent Details</h6>
                    <div className="space-y-2">
                        ...
                        <input name="annual_income" onChange={handleInput} className="w-full px-1 py-2 rounded-lg font-sans font-medium border border-gray-400  text-sm  focus:border-3   bg-white  focus:border-gray-400" type="number" step="0.01" />
                    ...
                    <div className="grid lg:grid-cols-5 md:grid-cols-1 gap-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <input name="mother_email_id" disabled={checkboxState.mother} onChange={handleInput} className={`w-10/12 px-1 py-2 rounded-lg font-sans font-medium border border-gray-400  text-sm  focus:border-3   bg-white  focus:border-gray-400 ${checkboxState.mother ? 'opacity-50' : ''}`} type="text" />
                        </div>
                        <div className="flex items-center">
