  ...
  return (
    <>
        <div  >
            ...
            <motion.div variants={fadeIn("up", 0.2)} initial="hidden" whileInView={"show"} viewport={{once:true, amount: 0.3}} className="h-auto w-auto flex flex-col items-center shadow-lg bg-primary rounded-md text-white ">
                ...
                <div className="lg:w-1/2 w-auto text-wrap border-none rounded-sm bg-white text-black m-6 p-4 lg:m-0 lg:mb-10 lg:p-10  items-center space-y-4">
            ...
            <div>
            <motion.div variants={fadeIn("down", 0.2)} initial="hidden" whileInView={"show"} viewport={{once:true, amount: 0.5}} className='p-10 hidden lg:block ' >
                <div className='flex h-1/2 w-full bg-gray-200 shadow-lg rounded-md space-x-96 p-10'>
            ...
            <div className='p-2'> 
                <motion.div variants={fadeIn("down", 0.2)} initial="hidden" whileInView={"show"} viewport={{once:true, amount: 0.5}} className='flex lg:hidden flex-col h-1/2 w-full shadow-lg bg-gray-200 pb-3 rounded-md p-2'>
