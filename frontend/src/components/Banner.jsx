...
export function Banner()  {
    ...
    return (
        <>
            <nav className=' bg-white  md:px-14 p-3 max-w-screen-2x1 sticky z-10 lg:border-b mx-auto top-0 right-0 left-0'>
            ...
            {/* Mobile responsive */}
            <div className={`space-y-6 px-6 pt-5 pb-5 mt-2 bg-blue-400 font-semibold  ${isMenuOpen ? "block sticky z-10 top-24 right-0 left-0": "hidden"}`}>
            {
                navItems.map(({link, path}) => (
                ...
                <div className='flex justify-around items-center'> {/* Align items at the center */}
                  ...
                  <button onClick={handleRegistrationClick}>Resgistration</button>
                  </div>
